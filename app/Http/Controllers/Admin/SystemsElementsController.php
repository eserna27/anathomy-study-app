...
class SystemsElementsController extends Controller
{
  public function create($system_id){
    ...
    return view('admin.elements_for_region_and_systems.create', compact('system', 'kind_options', 'regions_options', 'element'));
  }
  ...
  public function edit($system_id, $element_id)
  {
    ...
    $regions_options = Region::options_for_select();
    $element = Element::find($element_id);
    return view('admin.elements_for_region_and_systems.edit', compact('element', 'system', 'kind_options', 'regions_options'));
  }
